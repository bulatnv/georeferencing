...
> **Статус:** все фазы 0–5 реализованы на синтетическом стенде. 326 тестов
> зелёных (+4 gated по torch), ~24 с. Осталась внешняя валидация: боевые веса
> (torch) и реальные бортовые кадры с GPS/INS. Подробно — [docs/STATUS.md](docs/STATUS.md).
...
scripts/           run_benchmark · run_ladder · build_index
tests/             326 тестов
```
