...
Всего в каталоге **1158** растров. В датасет вошли пары с **612** из них (53 %), суммарно 4053 пар.
...
| использован полностью | 399 | дал пары обоих видов — и с подложкой, и «сам на себя» |
| использован частично | 191 | дал только пары «сам на себя»: с подложкой пары либо не построились, либо забракованы аудитом |
| не использован | 27 | годен по паспорту, но пар не дал |
| использован (только с подложкой) | 22 | пары с подложкой есть, «сам на себя» не вышли |
...
191 растров дали пары «сам на себя», но не дали пар с
...
215 растров (360 км²) не дали пар с подложкой из-за того, что привязку не удалось измерить. Из них **104 были близки к порогу**: валидные узлы нашлись, но их не набралось пять.
