...
#: Вес `exact` подобран под **сокращённую** ось: после prune_same_source её
#: осталось около 800 пар вместо 3218, и прежние 0.15 опустили бы долю в смеси
#: до четырёх процентов — ось перестала бы работать даже контролем.
WEIGHTS = {"exact": 0.5, "registered": 1.0, "approx": 0.3}
